...
/*Tar 1 */
function myReverse ( myParentElement ) {
    var myInputElement  = myParentElement.children[3];
    var myOutputElement;
    var myString = myInputElement.value;
    ...
    console.log(temp);
    myOutputElement = myParentElement.children[5];
    myOutputElement.innerHTML = temp;
}
